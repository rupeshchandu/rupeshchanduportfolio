          ...
          origin-top dark:bg-primary md:w-[2px] md:left-[29px] xs:left-[19px]'/>
            <ul className='w-full flex flex-col items-start justify-between ml-4 xs:ml-2'>
                ...
                <Details
                  ...
                  time = "2022-2023"
                  place = "YouTube"
                  info = "Completed coursework in Front-end Technologies, Data Structures and Algoritms, Data Base Fundamentals and C++ Programming."
                />

                <Details
                  type = "12th Board (STATE)"
                  time = "2017-2019"
                  place = "Narayana Junior College"
                  info = "Ongole, Andhra Pradesh, India."
                />
